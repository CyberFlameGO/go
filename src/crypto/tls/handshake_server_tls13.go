...
func (hs *serverHandshakeStateTLS13) doHelloRetryRequest(selectedGroup CurveID) error {
	...
	if hs.echIsInner() {
		// Construct an "encrypted_client_hello" extension in preparation for
		...
		echAcceptConfHRRTranscript.Write(helloRetryRequest.marshal())
		...
		helloRetryRequest.ech = echAcceptConfHRR
